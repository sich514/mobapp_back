                    ...
                    "content": [
                        {
                            "type": "input_text",
                            "text": (
                                "На изображении может быть еда. "
                                "Если еда есть — посчитай её суммарную калорийность и верни только одно число, например: 520. "
                                "Если еды на изображении нет — всегда возвращай 0. "
                                "Никаких дополнительных слов, знаков или форматов — только одно число без пояснений."
                            )
                        },
                        {
                            "type": "input_image",
